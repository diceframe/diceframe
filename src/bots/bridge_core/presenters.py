...
def bind_success_text(result: dict[str, Any], *, command_prefix: str = "@我") -> str:
...
def unbound_group_text(*, command_prefix: str = "@我") -> str:
    return (
        "本群尚未绑定游戏。\n"
        "GM 开团步骤：\n"
        "1. 打开网页里的当前游戏\n"
...
def unclaimed_player_text(group: dict[str, Any], *, command_prefix: str = "@我") -> str:
    return (
        "你还没认领角色，所以暂时不能行动。\n"
...
def bound_help_text(group: dict[str, Any], *, command_prefix: str = "@我") -> str:
    return (
        "DiceFrame 群聊新手指南：\n"
...
def character_creation_lines(data: dict[str, Any], *, command_prefix: str = "@我") -> list[str]:
...
def player_tutorial_lines(*, command_prefix: str = "@我") -> list[str]:
    return [
