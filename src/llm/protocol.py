...
KNOWN_PROTOCOL_TAGS = frozenset({
    "HP", "GOLD", "PAY", "TEAM_PAY", "SCENE", "SCENE_IMAGE", "SCENE_PANEL", "NPC", "LOOT", "KEY_ITEM", "DECISION",
    "QUEST", "USE", "WEAPON", "WEAPON_GAIN", "EQUIP", "EQUIP_ITEM", "UNEQUIP_ITEM", "PRIVATE",
    "XP", "MILESTONE", "SAN", "SAN_CHECK", "LUCK", "SKILL_GROWTH", "PUSH", "PUZZLE", "MANA",
    "SPELL", "QUICK_ACTIONS", "COMBAT", "REVIVE", "CONFIRMED", "MEMORY", "STAT",
    "FREE_GRANT",
})
